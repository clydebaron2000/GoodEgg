...
| `Dashboard` | — | Generated by `buildDashboard()`: KPIs + formula-driven aggregation tables, plus a JS-computed **Stock runway** snapshot (days-to-depletion per size, conservative of a 14-day and a day-of-week rate). Rebuild any time; add charts manually |
